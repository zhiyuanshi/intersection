...
\inferrule* [right=\labeltblam]
  {\jcheck {\Gamma, \alpha} e A \yields E \\
   \alpha \not \in \ftv \Gamma}
  {\jcheck \Gamma {\blam {\alpha} e} {\for {\alpha} A} \yields {\blam \alpha E}}
}

\newcommand{\bruletblamdis}{
\inferrule* [right=\labeltblam]
  {\jwf \Gamma A \\
   \jcheck {\Gamma,\alpha \disjoint A} e B \yields E \\
   \alpha \not \in \ftv \Gamma}
  {\jcheck \Gamma {\blamdis \alpha A e} {\fordis \alpha A B}
    \yields {\blam \alpha E}}
}
...
\inferrule* [right=\labelttapp]
  {\jinfer \Gamma e {\for {\alpha \disjoint B} C} \yields E \\
   \jwf \Gamma A \\
   \jdis \Gamma A B}
