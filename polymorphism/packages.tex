...
\setlength{\spacingtheorem}{1mm}
% http://tex.stackexchange.com/questions/28165/amsthm-how-to-reduce-the-vertical-spacing-between-theorem-and-proof
...
\lstdefinestyle{fi}{
  ...
  morekeywords={type,forall,let,rec,in,fun},
  otherkeywords={->},
  morecomment=[l]{--},
