...
Intersection types~\cite{coppo1981functional,Pottinger80type} are an increasingly popular language feature for
modern programming languages, such as Microsoft's TypeScript~\cite{typescript}, 
Redhat's Ceylon~\cite{ceylon}, Facebook's Flow~\cite{flow} and \joao{cited websites}
...
types, which has been known for a long time~\cite{} \joao{I could not find the first use}, 
...
role~\cite{oliveira2013feature}. \joao{any other uses?} 
