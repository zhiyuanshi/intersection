...
\paragraph{Merge operator and pairs.}\bruno{We may be able to skip
...
\subsection{Adding parametric polymorphism}\bruno{avoid writting
...
Having covered the core concepts behind \oldname and Dunfield's calculus,
...
Naturally\bruno{words like ``Naturally'', ``Essentially'' and so on
  rarelly add anything yo your text. Just drop them. } a first attempt at restoring coherence forbid type variables inside
