...
This means that its constraint is actually $\top$. 
For example, the identity function type $\forall \alpha. \alpha \to \alpha$ is syntactic sugar
for  $\fordis \alpha \top {\alpha \to \alpha}$.
We will discuss this in more detail in Section~\ref{sec:disjoint}. 
