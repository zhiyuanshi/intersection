...
The notion of disjoint quantification is inspired on bounded polymorphism \joao{refs}.
...
In another line of work are qualified types \joao{refs}, which uses predicates on types to
express constraints.
