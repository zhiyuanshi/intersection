...
The reason for this is covered in greater detail in Section~\ref{sec:disjoint}.
...
However, in \name, the polymorphic extensible records implementation instead piggybacks on the disjointness
...
This means that concerns with type inference, efficiency, expressibility, etc.; are to be dealt with 
compiling disjoint intersection types as opposed to compiling records directly.
