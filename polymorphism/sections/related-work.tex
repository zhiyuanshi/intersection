...
Our work is an extension of the recent \oldname calculus~\cite{oliveira16disjoint}.
...
The definition states that, two types $A$ and $B$ are disjoint if two conditions are satisfied:
