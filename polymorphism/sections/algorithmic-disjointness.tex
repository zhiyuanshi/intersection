...
\begin{enumerate}
\item As types: restricted (i.e. disjoint) intersections are required to ensure coherence.
\item As constraints: unrestricted intersections are sufficient for constraints under 
