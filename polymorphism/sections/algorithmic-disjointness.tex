...
\begin{lemma}[Disjointness is stable under substitution]
  ...
  If $(x \disjoint C) \in \Gamma$ and $\jdis \Gamma C D$ and $\jdis \Gamma A B$, 
  then $\jdis {\subst C x \Gamma} {\subst C x A} {\subst C x B}$.
\end{lemma}}
{\noindent \emph{Proof.} By induction on the disjointness derivation of $C$ and $D$.
...
%\end{restatable}
{\noindent \emph{Proof.} By induction on the well-formedness derivation of $A$.
...
\end{restatable}}
{\noindent \emph{Proof.} By induction on the derivation and applying
