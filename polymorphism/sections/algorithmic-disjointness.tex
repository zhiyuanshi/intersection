...
$\top$\bruno{This explanation is too brief! In our previous system top
was not disjoint to anything. You need to explain here why is it ok
for top to be disjoint to everything.}. Type variables are dealt with two rules:
...
\end{lemma}
\bruno{In several places in this section you are using $x$ as a type
  variable, when you should instead be using $\alpha$. You need to 
be consistent with your own notation: you defined $x$ to be a (term)
variable and $\alpha$ to be a type-variable.}
