...
\bruno{I think we should swap the order of the examples: TypeScript
  mixins first, and extensible records second.}
...
novel and has been extensively studied in the past\bruno{references
  here; and give names to a few approaches (row types for example)}. Most of the
...
\bruno{Why do w have two versions of the code in this section? Can we
  remove one.}
