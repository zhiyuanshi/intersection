...
disjoint.\bruno{Two things: 1) the example would be accepted and not
  rejected (as you mentioned earlier); 2) I think we need to say more
  are allowing duplicated fields somewhere, and perhaps have a
  reference here pointing to that additional discussion.} 
