...
to records, then the intersection \lstinline$Person & ConsoleLogger$ would be well-typed.
However, the intersection \lstinline$Person & Dog$ would be ill-typed, since they share the
