...
\subsection{Bi-directional type-system with Elaboration}
\joao{I'll move this with the previous section}
...
Because of this, our system needs to ensure that types are well-formed under substitution
More formally, the following lemma should hold:

\joao{missing talking about wellformedness of contexts}
\begin{lemma}[Well-formedness is stable under substitution]
  \label{lemma:wfsubst}
...
\joao{maybe move this to the overview?}
...
\joao{change this to bidi. typing and add proof sketch}
...
\joao{change this to bidi. typing}
\begin{restatable}[Unique elaboration]{theorem}{uniqueelaboration}
  \label{theorem:unique-elaboration}
