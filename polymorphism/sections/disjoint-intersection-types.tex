...
\joao{added explanation for new rules, still need better example}
...
It is also noteworthy pointing out that, as usual, the rule \reflabel{\labeltmerge} translates merges 
into pairs.
...
\joao{from what I could gather we use it for type-safety, but I will double-check this}
\begin{proof}
...
For \reflabel{\labeltapp}: \joao{below same as ICFP's paper}
\begin{mathpar}
\bruletapp
\end{mathpar}
