...
Our definition of top-like types is more liberal (i.e. more types are accepted as top-like) 
in comparsion with \oldname, due to our modified version of disjointness.
The new rules that compose this unary relation, denoted as $\toplike{ . }$,are presented at the top of 
Figure~\ref{fig:disjointness}. 
...
Atomic types are just those which are not intersection
...
%at the same time. 
TODO
More formally, as also shown in ..., with disjoint intersections 
