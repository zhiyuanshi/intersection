...
\inferrule* [right=$\rulelabeletop$]
  { }
  {\judgee \gamma \emptyrec \emptyrec \yields {()}}
}
...
\newcommand{\ruleerecselelab}{
\inferrule* [right=$\rulelabelerecsel$]
  {\judgee \gamma e \tau \yields E \andalso
   \judgeget \tau l {\tau_1} \yields C}
  {\judgee \gamma {e.l} {\tau_1} \yields {\app C E}}
}

\newcommand{\ruleerecreselab}{
\inferrule* [right=$\rulelabelerecres$]
  {\judgee \gamma e \tau \yields E \andalso
   \judgeres \tau l {\tau_1} \yields C}
  {\judgee \gamma {e - l} {\tau_1} \yields {\app C E}}
}
...
\newcommand{\ruleres}{
  \inferrule* [right=$\rulelabelres$]
  { }
  {\judgeres {\recty l \tau} l \emptyrec}
}

\newcommand{\rulereselab}{
  \inferrule* [right=$\rulelabelres$]
  { }
  {\judgeres {\recty l \tau} l \emptyrec \yields {\lam x {\im {\recty l \tau}} {()}}}
}

\newcommand{\ruleresleft}{
  \inferrule* [right=$\rulelabelresleft$]
  {\judgeres {\tau_1} l \tau}
  {\judgeres {\tau_1 \andop \tau_2} l {\tau \andop \tau_2}}
}

\newcommand{\ruleresleftelab}{
  \inferrule* [right=$\rulelabelresleft$]
  {\judgeres {\tau_1} l \tau \yields C}
  {\judgeres {\tau_1 \andop \tau_2} l {\tau \andop \tau_2} \yields {\lam x {\im {\tau_1
          \andop \tau_2}} {\pair {\app C {(\proj 1 x)}} {\proj 2 x}}}}
}

\newcommand{\ruleresright}{
  \inferrule* [right=$\rulelabelresright$]
  {\judgeres {\tau_2} l \tau}
  {\judgeres {\tau_1 \andop \tau_2} l {\tau_1 \andop \tau}}
}

\newcommand{\ruleresrightelab}{
  \inferrule* [right=$\rulelabelresright$]
  {\judgeres {\tau_2} l \tau \yields C}
  {\judgeres {\tau_1 \andop \tau_2} l {\tau_1 \andop \tau} \yields {\lam x {\im {\tau_1
