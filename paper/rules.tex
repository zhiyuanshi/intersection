...
\newcommand{\rulegetleftelab}{
  ...
  {\judgeget {\tau_1 \Intersect \tau_2} l \tau \yields {\Lam x {\im {\tau_1
          \Intersect \tau_2}} {\App C {(\Proj 1 x)}}}}
}
...
\inferrule* [right=$\rulelabelputleft$]
  ...
  \yields {\Lam x {\im {\tau_1 \Intersect \tau_2}} {\App C {(\Proj 1 x)}}}}
}
...
\inferrule* [right=$\rulelabelputright$]
  ...
  \yields {\Lam x {\im {\tau_1 \Intersect \tau_2}} {\App C {(\Proj 2 x)}}}}
}