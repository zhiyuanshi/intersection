...
record systems, is replaced the merge operator, discussed earlier. Working with
records is type-safe: the type system prevents accessing or updating a field
that does not exist.
