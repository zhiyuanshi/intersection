...
and it enjoys of properties such as \emph{idempotence} and \emph{commutativity}: \\
...
\emph{selection}, and \emph{update}. \emph{Extension},\george{FIXME} described in many other
