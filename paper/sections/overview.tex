...
\emph{projection}, and \emph{update}. The merge operator, discussed previously,
takes the place of record extension described in many other record systems.
Working with records is type-safe: the type system prevents accessing or
updating a field that does not exist.
