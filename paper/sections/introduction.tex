...
used with existing mainstream languages~\cite{togersen:2004,Zenger-Odersky2005,oliveira09modular,oliveira2012extensibility}.
...
features, such as \emph{generics}~\cite{}, in combination with conventional
...
1) lack of good mechanisms for
  ...
  Programming~\cite{} or Attribute Grammars using Object
