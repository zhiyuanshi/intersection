...
Expressions also inlcude standard constructs in System
...
repository which includes our implementation and formalization. \bruno{State the
  reflexivity and transitivity Lemmas here then!}
