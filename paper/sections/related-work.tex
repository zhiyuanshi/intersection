...
% http://research.microsoft.com/en-us/people/daan/

% Object: self, mutable, inheritance, recursive records

% Scala:
% (1) Already intersection in the language
% (2) Attempts to formalize: DOT calculus
% Intersection types in existing OO languages: Ceylon, Grace
...
% Don't want to impose restriction on what can be merge. In the example, there
% is A&B.
...
% How about this line of work related to inheritance?
