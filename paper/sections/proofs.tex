...
\begin{lemma}[\rulelabelselect~rules produce type-correct coercion] \label{lemma:get-correct}
...
\begin{lemma}[\rulelabelrestrict~rules produce type-correct coercion] \label{lemma:get-correct}
