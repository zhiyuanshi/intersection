...
\rulename{Get-Base} $ \Gamma \turnsget \recty l \ty ; l = \idmono {\image {\recty l \ty})} ; \ty $ \\
...
\rulename{Abs} $ \Gamma \turns \lambda (x : \ty_1). e : \ty_1 \to \ty_2 \yields {\absty x {\image {\ty_1}} E} $ \\
...
\rulename{TAp} $ \Gamma \turns e \; \ty  : [\alpha := t] \ty_1 \yields {E \; \image \ty} $ \\
