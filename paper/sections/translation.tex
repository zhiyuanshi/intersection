...
expression\bruno{Still not showing the derivations!}
\[
...
\paragraph{``Restrict'' rules.}\bruno{Missing example (and derivation)}
...
{\pair 0 0}
\]
After evaluation, the target expression becomes just $\pair 0 {()}$.
