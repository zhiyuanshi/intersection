...
% http://tex.stackexchange.com/questions/18045/problem-with-compiling-bibtex-no-citation-commands-error
% If you only want a reference to appear in the bibliography, but not where it
% is referenced in the main text, then the \nocite{} command can be used.
\nocite{*}
