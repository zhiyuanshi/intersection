...
% Judgments
\newcommand{\jwf}[2]{#1 \turns #2 \; \text{type}}
\newcommand{\isatomic}[1]{#1 \ \text{atomic}}
\newcommand{\jtype}[3]{#1 \turns #2 \ \oftype \ #3}
\newcommand{\jdis}[3]{#1 \turns #2 * #3}
\newcommand{\jdisimpl}[3]{#1 \turns #2 *_I #3}

\newcommand{\reflabel}[1]{«\textsc{#1}»}  % French quotation marks
\newcommand{\ruleWF}{\george{\text{ruleWF}}}
\newcommand{\labelWF}{\george{\text{labelWF}}}
\newcommand{\labeltgtWF}{\george{\text{labeltgtWF}}}
