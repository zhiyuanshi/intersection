...
materials submitted with the paper.\bruno{should we mention the coq proofs?}
...
the bottom part of the figure. Again, the reader is advised to omit the
...
\]
generates a coercion function from $\tyint \inter \tybool \to \tybool$.
