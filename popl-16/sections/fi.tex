...
the bottom part of the figure. Again, the reader are advised to omit the
gray-shaded part here, as they will be explained later. The typing judgement is
...
parameter ($A_1$). \reflabel{\labeltmerge} means for merges $e_1 \mergeop e_2$,
we typecheck $e_1$ and $e_2$ separately, and give it the intersection of the
resulting types.
