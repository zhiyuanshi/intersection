...
Reynolds~\ref{reynolds1991coherence} proved coherence in a language with
intersection types based on lambda-calculus. But his language does not support
quantification. To the best of our knowledge, this is the only work that deals
with the coherence problem in languages having intersection types.
