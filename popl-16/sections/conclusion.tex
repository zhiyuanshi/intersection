...
We have described a System $F$-based language that combines subtyping,
polymorphism, and intersection types. The language has also a term-level
introduction form for intersection types. We have proved that the language is
type-safe and coherent.
...
intersection does not matter, we may normalise them to avoid unnecessary
coercions.
