\newcommand{\judgeTargetWF}[2]{#1 \; \textcolor{Maroon}{\turns} \; #2}
\newcommand{\judgeTarget}[3]{#1 \; \textcolor{Maroon}{\turns} \; #2 \; \textcolor{Maroon}{:} \; #3}
\newcommand{\ruleLabelTarget}{\bm{\textcolor{Maroon}{T}}}
