...
\inferrule* [right=$\rulelabelLam$]
  {\hastype {\Gamma, x \hast A} e B \yields E \\ \judgeSourceWF \Gamma A}
...
\inferrule* [right=$\rulelabelTApp$]
  {\hastype \Gamma e {\for \alpha B} \yields E \\ \judgeSourceWF \Gamma A}
...
\inferrule* [right=$\rulelabelMerge$]
  ...
  {\hastype \Gamma {e_1 \mergeOp e_2} {\constraints {A \disjoint B} {A \intersect B}} \yields {\pair {E_1} {E_2}}}
}

% DisjointAssume
\newcommand{\rulelabeldisjointassume}{\rulelabel\text{DisjointAssume}}
\newcommand{\ruleDisjointAssume}{
\inferrule* [right=$\rulelabeldisjointassume$]
...
% DisjointCheck
\newcommand{\rulelabeldisjointcheck}{\rulelabel\text{DisjointCheck}}
\newcommand{\ruleDisjointCheck}{
\inferrule* [right=$\rulelabeldisjointcheck$]
  {\hastype \Gamma e {\constraints {A_1 \disjoint A_2} B} \yields E \\
  \isdisjoint \Gamma {A_1} {A_2}}
  {\hastype \Gamma {e} B \yields E}
}
