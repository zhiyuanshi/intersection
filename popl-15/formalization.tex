...
\begin{figure*}
  \begin{mathpar}
    \inferrule* [right=Cast::Base]
      { }
      {\cast \tau {\withType v \tau} \hookrightarrow \withType v \tau}

    \inferrule* [right=Cast::Left]
      {\cast \tau {\withType {v_1} {\tau_1}} \hookrightarrow \withType v \tau}
      {\cast \tau {\withType {v_1 \mergeOp v_2} {\tau_1 \andOp \tau_2}} \hookrightarrow \withType v \tau}

    \inferrule* [right=Cast::Right]
      {\cast \tau {\withType {v_2} {\tau_2}} \hookrightarrow \withType v \tau}
      {\cast \tau {\withType {v_1 \mergeOp v_2} {\tau_1 \andOp \tau_2}} \hookrightarrow \withType v \tau}
  \end{mathpar}
