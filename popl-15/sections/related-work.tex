...
% {\Gamma \turns e : \tau_1 \intersect \tau_2}
% into one rule:
% \inferrule [Merge]
% {\Gamma \turns e_1 : \tau_1 \andalso \Gamma \turns e_2 : \tau_2}
% {\Gamma \turns e_1 \mergeOp e_2 : \tau_1 \intersect \tau_2}
...
% if an term has been inferred of type $ \tau $, then it is also of any
