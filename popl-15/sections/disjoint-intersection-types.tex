...
\george{Show that the naive bidirectional subtyping is not disjointness.}
\george{Highlight new stuff}
...
\george{Missing the merge rule, as it is also changed.}
...
one without such restrictions.\george{Point to proofs and justify why the proof shows this.}
...
\george{Put type safety to previous section and just say that it also holds here.}
