...
and Frisch et. al~\cite{frisch2008semantic}). The rule \rulelabel{SubFun} says that a function is
...
the rule \rulelabel{SubAnd} says that if $\tau_1$ is both the subset of $\tau_2$
