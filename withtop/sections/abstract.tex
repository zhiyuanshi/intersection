...
supertype.
\bruno{Abstract needs to be fixed, disjointness is no longer the absence of 
a common supertype!} We present a type system that prevents intersection types that are
...
designs of object-oriented programming languages.\bruno{Drop sentence about 
traits and replace by other contributions?}
