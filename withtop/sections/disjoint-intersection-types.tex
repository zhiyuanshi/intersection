...
Section~\ref{sec:fi}. The type system is elaborating, producing a term 
...
We will use the definition of erasure, as shown in Figure~\ref{fig:type-ann-erasure}.
...
\begin{proof}
  ...
  The latter requires inference of a function type, forcing the use of a type annotation.
