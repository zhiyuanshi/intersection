...
\paragraph{Unique coercions and unique types}
The bidirectional type system makes it easier to prove 
coherence. The type system in Figure~\ref{} accepts programs such as:

\begin{lstlisting}
3,,'c'
\end{lstlisting}

\noindent Such a program can be assigned multiple types (for example ...), and 
