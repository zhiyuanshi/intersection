...
The reader might notice that the choice for this type-system in rather
unconventional, as it does not follow the rule of making introduction forms as checked
and elimination forms as synthesized \cite{davies2000intersection} \cite{Dunfield04tri}.
However, we can justify our design with several reasons:

\begin{enumerate}
\item We aim at maximizing type-inference: annotation becomes 
...
for the system, and other design choices could be equaly justified had our intentions been
different.
