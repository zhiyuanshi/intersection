...
arizing from subtyping. The additional coercions are necessary to
...
modelled as a single relation, where the mode is an additional
parameter of the relation. Thus for theorems that need both judgements
