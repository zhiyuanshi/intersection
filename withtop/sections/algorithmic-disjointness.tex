...
taken care of two types with the same language constructs. But how can the
...
\begin{restatable}[Completeness of algorithmic disjointness]{theorem}{algodiscompleteness}
  ...
  For any two well-formed types $A$ and $B$, $\jdis \Gamma A B$ implies $\jdisimpl \Gamma A B$.
\end{restatable}
