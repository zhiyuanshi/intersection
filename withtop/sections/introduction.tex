...
\bruno{Need to mention bi-directional type system and uniqueness of types.}
...
other type. Unfortunatelly the simple notion of top-like types 
has limited expressiveness and forbids any two function types 
...
co-finite quantification~\cite{} to represent variables and
binders. Except for two auxiliary lemmas used in the lambda cases for
the proofs of soundness and completeness of the bi-directional
type-checking algorithm, all proofs are ``admit'' free. In particular,
