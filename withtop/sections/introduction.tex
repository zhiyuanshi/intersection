...
bidirectional type-checking techniques~\cite{Pierce00local,Dunfield04tri}, that ensures that 
...
meta-theoretical results in the Coq proof assistant. 
%The definitions and proofs can be found at https://github.com/jalpuim/disjoint-intersection-types. 
The definitions and proofs use the locally nameless representation with
...
the proofs of soundness and completeness of bidirectional
...
encodings of several examples presented in the paper, and also the Coq
proofs are available at:

{\small \url{https://github.com/jalpuim/disjoint-intersection-types}}
