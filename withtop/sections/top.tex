...
The algorithmic disjoitness rules remain the same as described in Section \ref{sec:TODO} \joao{fill in section}, except
for \reflabel{\labeldisfun}.
\joao{explain and motivate the next section}
