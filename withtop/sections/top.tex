...
A top-like type can be formalized as an unary relation on a type $A$, denoted as $\toplike{A}$, as show in 
...
disjointess rules, shown in Figure~\ref{fig:tltypesdis}, remain the almost same as described in Section
