...
\begin{figure}[h]
  ...
  \begin{mathpar}
    \formsub \\
    \rulesubinterlnottop \and \rulesubinterrnottop \\ 
    \rulesubintertopl \and \rulesubintertopr
  \end{mathpar}
  ...
  \caption{Top-like types, Subtyping (new/changed rules only) and Algorithmic Disjointness for the improved calculus.}
