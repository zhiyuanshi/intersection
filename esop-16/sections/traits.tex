...
% \bruno{I still feel that having an example in
...
As a comparison, in Scala we would write\bruno{Scala code comes out of the blue here. 
Consider having this code in related work, when comparing to Scala.}
