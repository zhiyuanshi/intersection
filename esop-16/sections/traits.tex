...
\bruno{write a topic sentence: what is this paragraph about?}
...
\george{Actually we can also define a trait inside a function, which is impossible in Scala.}
...
\begin{lstlisting}
  = let rec x : () (*$ \to $*) Point = (*$ \lambda $*)(_: ()) (*$ \to $*) f x in x ()
in (* \ldots *)
\end{lstlisting}
