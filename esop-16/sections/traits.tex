...
conflict detection, etc.\bruno{I still feel that having an example in
  text and another in code its probably redundant. Do we really need
  to talk about rectangles here?}
...
\end{lstlisting}\bruno{Wrong! we discussed this in the meeting}
