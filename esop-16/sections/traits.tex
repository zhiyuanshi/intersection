...
in object-oriented programming. While the main goal of \name is not to model
...
\george{Example: A function that takes a trait with unknown implementation and
instantiate it. But need to think what the ``type'' of the trait should be in
this case.}
