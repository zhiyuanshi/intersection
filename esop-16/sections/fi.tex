...
\lstinline$f : Int -> Bool$ and \lstinline$g : Int -> Char$, we could select  \lstinline$f$
...
\noindent where idInt : Int -> Int and idChar : Char -> Char are,
...
different treatment, if we wish to have coherence.\bruno{work in progress}  
