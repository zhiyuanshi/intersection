...
\[ \code{Int} \to \code{Int} \quad \text{and} \quad (\code{Int} \to \code{Int}) \inter (\tystring \to \tystring) \]
...
context. Under the new rules, intersection types such as $\code{Int} \inter \code{Int}$
