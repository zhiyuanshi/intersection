...
source language's traits have three major differences.
...
\begin{enumerate}
  ...
  \item Scala allows traits to contain methods whose body is not implemented but
  our current language does not support this feature.
