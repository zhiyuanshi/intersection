...
assistant. \bruno{type-safety and the final coherence theorem are not in the Coq
file.}

As an application of \name, we show that \name can serve as a
foundation of for a trait-based~\cite{}\bruno{Sharli} object-oriented
...
online\footnote{
\url{https://github.com/zhiyuanshi/intersection/tree/master/esop-16/examples}\bruno{What
