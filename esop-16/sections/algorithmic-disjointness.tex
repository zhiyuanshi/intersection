...
% wrong. For example, $\code{Int} \inter \tystring$ and $\tystring \inter \code{Char}$ are
...
%   \code{Char}$, $\code{Char} \inter \code{Int}$, $(\code{Int} \inter \tybool) \inter \code{Char}$
...
% example,  \[ \{ \code{Int}, \tystring \} \to \{ \code{Int}, \code{Char} \} \] is a shorthand for \[ \{
% \code{Int} \to \code{Int}, \code{Int} \to \code{Char}, \tystring \to \code{Int}, \tystring \to \code{Char} \} \]
%
%
