...
\bruno{are you sure about this?? Google for ``trait calculus'' and 
you will find many results!}.
However, we are going to show that \name is able to model all the important
features of trait.
\bruno{You need to use more structure in the section: use subsections and paragraphs 
to introduce the topics/ideas of what you are talking about. 
I have added a few.}

The simplest use case of traits is extracting a feature out from a model class.

\paragraph{Basic Traits} 
\bruno{Here you should explain the basics of traits and give 
an example of two traits with no dependencies at all}
